...
class RevisionsCommandTestCase(tests.TestCase):
    ...
    def setUp(self):
        ...
        self.expected = [{
            ...
            'channels': [],
            'version': '2.0.1',
            'timestamp': 'Tue Sep 27 19:23:40 2016',
            ...
            'version': '2.0.2',
            'timestamp': 'Tue Sep 27 18:38:43 2016',
    ...
    def test_revisions(self, mock_account_api, mock_revisions):
        ...
        expected_output = [
          ...
          '2       Tue Sep 27 19:23:40 2016  i386    2.0.1      -',
          '1       Tue Sep 27 18:38:43 2016  amd64   2.0.2      stable*, edge'
        ]
